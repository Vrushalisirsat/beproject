...
<?php
  ...
  if(isset($_SESSION['email'])){
    ...
    echo "<script>window.location.href='../php_college/login_page/popup.html'</script>";

  }
?>

<body>
<form action="insertCIVIL.php"  method="POST">
    <div>   
...
<br>
 ...
 #create connection
       ...
       if(isset($_POST['submit']))
       {
          ...
          $query="INSERT INTO maincivil(students_name,project_name,deparnment,guided_by,project_details) VALUES ('$studname','$projectname','$dept','$guidby','$projectdetails')";
