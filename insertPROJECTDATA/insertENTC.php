...
<body>
<form action="insertENTC.php"  method="POST">
    <div>   
...
<br>
 ...
 #create connection
       ...
       if(isset($_POST['submit']))
       {
          ...
          $query="INSERT INTO mainentc(students_name,project_name,deparnment,guided_by,project_details) VALUES ('$studname','$projectname','$dept','$guidby','$projectdetails')";
